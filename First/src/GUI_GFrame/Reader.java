...
public class Reader extends JFrame{   // создаем класс с наследованием команд из библиотеки пакета JFrame - графика
	JButton b1, b2;               // инициализируем 2 кнопки
	JLabel l1, l2, l3, l4;        //
	JTextField t1, t2;
	int i, k;
	String a, b;
	...
	public Reader(String s){   // конструктор
		...
		l1 = new JLabel("Ввведите первое число:");
		l2 = new JLabel("Ввведите второе число:");
		l3 = new JLabel("");
		l4 = new JLabel("");
		t1 = new JTextField(10);  //пространство на 10 символов ввода
